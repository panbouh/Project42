...
{
	char		key;
	int			(*f)(va_list ap, struct s_flag_list);
}				t_conv;

typedef struct	s_mod
{
	char		*key;
	int			(*f)(va_list ap, struct s_flag_list, const char *, size_t *);
}				t_mod;

typedef struct	s_flag
{
	char		key;
	void		(*f)(struct s_flag_list *);
}				t_flag;
...
void			check_for_pw(const char *form, size_t *y, t_flag_list *t_fl,
							va_list ap);
void			check_p(const char *form, size_t *i, t_flag_list *t_fl,
						va_list ap);
void			check_w(const char *form, size_t *i, t_flag_list *t_fl,
						va_list ap);
...
int				do_conv(const char *form, va_list ap, size_t *i,
						t_flag_list *t_fl);
...
int				ntmnorm(const char *form, va_list ap, size_t *i,
						t_flag_list *t_fl);
int				is_conv(char c);
